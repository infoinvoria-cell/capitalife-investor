...
export const TRACK_RECORD_THEMES: Record<TrackRecordTheme, TrackRecordPalette> = {
  dark: {
    ...
    panelBackground: "linear-gradient(180deg, rgba(16,14,10,0.88) 0%, rgba(8,8,8,0.82) 100%)",
    panelBackgroundStrong: "linear-gradient(180deg, rgba(17,15,11,0.92) 0%, rgba(8,8,8,0.86) 100%)",
    panelBorder: "rgba(236,219,166,0.18)",
    panelGlow: "rgba(236,219,166,0.12)",
    panelShadow: "inset 0 1px 0 rgba(255,247,227,0.07), inset 0 -18px 36px rgba(0,0,0,0.18), 0 22px 48px rgba(0,0,0,0.62), 0 0 28px rgba(236,219,166,0.08)",
    text: "#ffffff",
    heading: "#fffaf0",
    muted: "#8f98a3",
    accent: "#D6C38F",
  ...
  blue: {
    ...
    panelBackground: "linear-gradient(180deg, rgba(12,22,44,0.88) 0%, rgba(5,11,24,0.82) 100%)",
    panelBackgroundStrong: "linear-gradient(180deg, rgba(12,24,48,0.92) 0%, rgba(4,9,22,0.86) 100%)",
    panelBorder: "rgba(190,216,255,0.18)",
    panelGlow: "rgba(120,160,255,0.12)",
    panelShadow: "inset 0 1px 0 rgba(190,216,255,0.07), inset 0 -18px 36px rgba(0,0,0,0.18), 0 22px 48px rgba(0,0,0,0.58), 0 0 28px rgba(120,160,255,0.08)",
    text: "#ffffff",
    heading: "#eef4ff",
    muted: "#92a6c8",
    accent: "#4d87fe",
