...
const HISTORICAL_DATASET_RELATIVE_PATHS = [
  path.join("..", "trading_dashboard", "live track record", "data", "trades_clean_compounded.csv"),
  path.join("trading_dashboard", "live track record", "data", "trades_clean_compounded.csv"),
...
const APPENDED_DATASET_RELATIVE_PATHS = [
  path.join("..", "trading_dashboard", "live track record", "data", "trades_appended_api.json"),
  path.join("trading_dashboard", "live track record", "data", "trades_appended_api.json"),
